...
## User Experience (UX)
The primary goal is to provide an appealing and fun memory game for young children aged 3 - 6 years old.
### User Story
...
- The navigation menu shows 3 difficulty levels: easy, medium and hard.
...
- All pages are clean with emphasis on the game board which shows a range of animal photographs.
...
- The restart button is not levelled with the score counter when being moved across responsivly on screen.
